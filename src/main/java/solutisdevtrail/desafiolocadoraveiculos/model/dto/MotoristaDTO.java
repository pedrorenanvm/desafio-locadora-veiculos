...
public record MotoristaDTO(Long id, String name, Date dataNascimento, String cpf, Sexo sexo, String numeroCNH) {
    public MotoristaDTO(Motorista motorista) {
        this(motorista.getId(), motorista.getName(), motorista.getDataNascimento(), motorista.getCpf(), motorista.getSexo(), motorista.getNumeroCNH());
    }
}
